...
export default function Stack() {
  ...
  const [classes, setClasses] = useState('c-stack')

  useEffect(() => {
    let currentClasses = 'stack'
    if (inView) {
  ...
  return (
    <div className="c-stack">
      <div className="container mx-auto">
        <h2 className="text-center mb-16">My Most Recent Stack Involvement</h2>
        <ol className={classes} ref={ref}>
                ...
                <div className="flip-card-inner">
                  <div className="flip-card-front md:flex">
                    <div className="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10">
                      ...
                      <p className="text-black mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque scelerisque diam non nisi semper, et elementum lorem ornare. Maecenas placerat facilisis mollis. Duis sagittis ligula in sodales vehicula.</p>
                    </div>
                  </div>
            ...
            <div className="flip-card">
              <div className="flip-card-inner">
                <div className="flip-card-front md:flex justify-end">
                  <div className="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 md:ml-0 md:mr-6 mb-10">
